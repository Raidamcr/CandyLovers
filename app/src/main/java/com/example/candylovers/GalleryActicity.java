...
public class GalleryActicity extends AppCompatActivity {
    private static final String TAG = "GalleryActicity";
    ...
    private void setImage(String imageUrl, String imageName, String desc ){
        Log.d(TAG, "setImage: setting te image and to widgets.");
